...
int MXKVStoreGetAllWorkerSize(KVStoreHandle handle, int *size) {
  API_BEGIN();
  *size = static_cast<KVStore*>(handle)->get_all_worker_size();
  API_END();
}
...
int MXKVStoreIsGlobalServerNode(int *ret) {
  API_BEGIN();
  *ret = KVStore::IsGlobalServerNode();
  API_END();
}

int MXKVStoreIsGlobalSchedulerNode(int *ret) {
  API_BEGIN();
  *ret = KVStore::IsGlobalSchedulerNode();
  API_END();
}

int MXKVStoreIsMasterWorkerNode(KVStoreHandle handle, int *ret) {
  API_BEGIN();
  *ret = static_cast<KVStore*>(handle)->is_master_worker();
  API_END();
}
