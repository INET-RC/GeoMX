...
EXAMPLE_PYTHON_SCRIPT='../../examples/cnn_hfa.py'
...
MXNET_KVSTORE_HFA_K1=20 \
MXNET_KVSTORE_HFA_K2=10 \
nohup python -c "import mxnet" > /dev/null &
...
MXNET_KVSTORE_HFA_K1=20 \
MXNET_KVSTORE_HFA_K2=10 \
nohup python ${EXAMPLE_PYTHON_SCRIPT} --data-slice-idx 0 > /dev/null &
...
MXNET_KVSTORE_HFA_K1=20 \
MXNET_KVSTORE_HFA_K2=10 \
nohup python ${EXAMPLE_PYTHON_SCRIPT} --data-slice-idx 1 > /dev/null &
...
MXNET_KVSTORE_HFA_K1=20 \
MXNET_KVSTORE_HFA_K2=10 \
nohup python ${EXAMPLE_PYTHON_SCRIPT} --data-slice-idx 2 > /dev/null &
...
MXNET_KVSTORE_HFA_K1=20 \
MXNET_KVSTORE_HFA_K2=10 \
python -u ${EXAMPLE_PYTHON_SCRIPT} --data-slice-idx 3
